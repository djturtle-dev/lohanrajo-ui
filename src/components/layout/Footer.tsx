    ...
    return (
        <footer className="relative z-10 border-t border-brand-border bg-brand-panel py-12 px-4 sm:px-8 mt-auto">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <Image src="/Footer-logo.png" alt="LIAT" width={140} height={50} className="h-12 w-auto mb-4" />
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm text-brand-muted font-mono">
                        <li><a href="mailto:lohanrajoliat@gmail.com" className="hover:text-brand-accent transition-colors block">lohanrajoliat@gmail.com</a></li>
